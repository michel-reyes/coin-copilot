...
import type { TransactionAnomaly } from '@/prisma/generated/client/edge';

export const BASE_URL = DEV_MODE ? MOCK_BASE_URL + '/' : PRISMA_BASE_URL + '/server/';

// ------------------------------------------------------------------
// Account Settings
// ------------------------------------------------------------------
export const accountSettingsEndpoint = BASE_URL + PRISMA_ENDPOINTS.ACCOUNT_SETTINGS;
...
export const updateAccountSetting = async (accountId: string, updateData: any) => {
    try {
        const response = await fetch(accountSettingsEndpoint, {
            method: 'PUT',
            headers: {
...
// Transaction Anomaly
// ------------------------------------------------------------------
const transactionsAnomalyEndpoint = BASE_URL + PRISMA_ENDPOINTS.TRANSACTIONS_ANOMALY;
