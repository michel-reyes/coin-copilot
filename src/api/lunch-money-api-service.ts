import { lunchMoneyClient } from './api-client';
...
export const fetchTransactions = async (start: string, end: string) => {
    ...
    const response = await lunchMoneyClient.get(LUNCH_MONEY_ENDPOINTS.TRANSACTIONS + queryParams);
...
export const fetchPlaid = async () => {
    ...
    const response = await lunchMoneyClient.get(LUNCH_MONEY_ENDPOINTS.PLAID_ACCOUNTS);
    return response.data;
};
...
export const fetchCategories = async () => {
    ...
    const response = await lunchMoneyClient.get(LUNCH_MONEY_ENDPOINTS.CATEGORIES + queryParams);
    return response.data;
};
...
export const fetchBudgets = async (start: string, end: string) => {
    ...
    const response = await lunchMoneyClient.get(LUNCH_MONEY_ENDPOINTS.BUDGETS + queryParams);
    return response.data;
};
