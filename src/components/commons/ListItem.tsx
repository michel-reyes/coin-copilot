...
const ListContent = forwardRef<RNView, Partial<ListItemProps>>(
  (
    {
      title,
      hint,
...
export const ListItem = forwardRef<RNView, ListItemProps>(
  ({ href, showActionIcon, style, ...props }, ref) => {
    const isLink = href !== undefined;
    const _showActionIcon = showActionIcon || isLink;
    const content = (
      <ListContent ref={ref} showActionIcon={_showActionIcon} {...props} />
    );
    ...
    return (
      <RNView ref={ref} style={containerStyle} {...props}>
        {content}
      </RNView>
    );
  }
